...
public class ListaGasolinerasActivityTestInsertarDistancia {

    @Rule
    public ActivityTestRule<ListaGasolinerasActivity> mActivityTestRule = new ActivityTestRule<>(ListaGasolinerasActivity.class);

    @Test
    public void listaGasolinerasActivityTestInsertarDistancia() {


        onData(allOf(withId(R.id.distancia), withText("4,30Km"),
                childAtPosition(
                        allOf(withId(R.id.distancia),
                                childAtPosition(
                ...
                isDisplayed()));
        onData(
                allOf(withId(R.id.distancia), withText("3,37Km"),
                        childAtPosition(
